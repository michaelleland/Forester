class CreateTickets < ActiveRecord::Migration
  def self.up
    ...
    Ticket.create(:delivery_date => "2011-09-12", :destination_id => 2, :job_id => 1, :paid_to_logger => false, :paid_to_owner => false, :paid_to_trucker => false, :number => 2435, :wood_type => 1, :value => 2314.94) 
    ...
    Ticket.create(:delivery_date => "2011-09-15", :destination_id => 1, :job_id => 2, :paid_to_logger => false, :paid_to_owner => false, :paid_to_trucker => false, :number => 2905, :wood_type => 3, :value => 2304.54)
